...
const About = () => {
  return (
    <div className="py-10 px-4 relative md:flex md:justify-between md:px-12">
      <div className="flex-1">
        <img src={pattern2} alt="pattern" className="absolute top-0 left-0" />
        <h3 className="text-2xl font-bold mb-4 md:text-xl">
          Giving our all is all we do
        </h3>
        <p className="text-gray-800 mb-5 md:text-sm md:text-justify md:w-96">
        ...
        <p className="font-cursive italic text-xl mb-2 md:text-lg">
          Nureni Jamiu O.
        </p>
